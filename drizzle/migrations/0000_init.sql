CREATE TYPE "public"."post_source" AS ENUM('github', 'manual');--> statement-breakpoint
CREATE TYPE "public"."post_status" AS ENUM('draft', 'published', 'archived');--> statement-breakpoint
CREATE TYPE "public"."attachment_type" AS ENUM('image', 'file', 'link');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('admin', 'editor', 'member');--> statement-breakpoint
CREATE TYPE "public"."comment_status" AS ENUM('pending', 'approved', 'rejected', 'spam');--> statement-breakpoint
CREATE TYPE "public"."sync_status" AS ENUM('pending', 'success', 'error');--> statement-breakpoint
CREATE TYPE "public"."sync_trigger" AS ENUM('webhook', 'cron', 'manual', 'setup');--> statement-breakpoint
